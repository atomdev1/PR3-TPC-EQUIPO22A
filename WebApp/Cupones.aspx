...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="d-flex align-items-center mb-4">
        ...
        <asp:Button ID="btnNuevoCupon" runat="server" CssClass="btn-r btn-primary-r ms-auto"
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <asp:Button ID="btnGuardarCupon" runat="server" Text="Guardar cupón"
                        CssClass="btn-r btn-primary-r" OnClick="btnGuardarCupon_Click" ValidationGroup="NuevoCupon" />
                </div>
            </div>
        </div>
    </div>
